...
('Yaş qrupu', 'select', '["18-25", "26-35", "36-45", "46-55", "55+"]', true, 1),
('Cins', 'select', '["Kişi", "Qadın", "Digər"]', true, 2),
('Maraqlandığı model', 'select', '["Sedan", "SUV", "Hatchback", "Coupe", "Crossover", "Luxury", "Electric"]', true, 3),
('Reklam mənbəyi', 'select', '["Google Ads", "Facebook", "Instagram", "Televizyon", "Radio", "Qəzet", "Dostun tövsiyəsi", "Digər"]', true, 4);
