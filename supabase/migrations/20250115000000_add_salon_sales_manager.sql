...
('Salon', 'select', ARRAY['Bakı Mərkəz', 'Bakı Yasamal', 'Bakı Nəsimi', 'Gəncə', 'Sumqayıt', 'Mingəçevir'], true, 5),
('Satış Meneceri', 'select', ARRAY['Əli Məmmədov', 'Leyla Həsənova', 'Rəşad Quliyev', 'Nigar Əliyeva', 'Tural Bayramov', 'Səbinə Nəbiyeva'], true, 6);
